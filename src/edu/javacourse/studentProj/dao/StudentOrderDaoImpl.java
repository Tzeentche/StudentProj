...
public class StudentOrderDaoImpl implements StudentOrderDao {
    ...
    private static final String SELECT_ORDERS=
        "SELECT so.*, ro.r_office_area_id, ro.r_office_name FROM jc_student_orders so " + " INNER JOIN jc_register_office ro ON " +
                "ro.r_office_id = so.register_office_id " + "WHERE student_order_status = 0 ORDER BY student_order_date";
